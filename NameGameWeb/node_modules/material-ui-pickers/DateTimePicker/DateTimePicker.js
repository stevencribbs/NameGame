...
var _DateTimePickerView = _interopRequireDefault(require("./DateTimePickerView"));

var _YearSelection = _interopRequireDefault(require("../DatePicker/YearSelection"));

var _Calendar = _interopRequireDefault(require("../DatePicker/Calendar"));

var _TimePickerView = _interopRequireDefault(require("../TimePicker/TimePickerView"));

var _DateTimePickerTabs = _interopRequireDefault(require("./DateTimePickerTabs"));

var _DateTimePickerHeader = _interopRequireDefault(require("./DateTimePickerHeader"));
...
DateTimePicker.propTypes = {
  ...
  openTo: _propTypes.default.oneOf((0, _keys.default)(viewType).map(function (key) {
    return viewType[key];
  })).isRequired,
